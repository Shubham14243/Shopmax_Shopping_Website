...
if (isset($_REQUEST['place'])) {
  ...
  for ($i=0; $i < count($pp); $i++) { 
    $aa = "INSERT INTO orders(uid, pid, price, status, method) VALUES('$uid', '$pp[$i]', '$pr[$i]', '$status', '$method')";
    $bb = mysqli_query($conn, $aa);
  }
  $sql_d = "DELETE FROM cart WHERE uid = '$uid'";
                ...
                <div class="p-3 p-lg-5 border"> 
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><?php echo $putr[3];?><strong class="mx-2">x</strong><?php echo $rows_p[3]; ?></td>
