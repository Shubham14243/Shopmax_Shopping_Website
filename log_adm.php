...
if (isset($_REQUEST['log'])) {
  ...
  if (empty($email) || empty($pswd) || empty($code)) {
    $show = "Please Fill All The Fields";
      ...
      $sql = "SELECT * FROM admin WHERE email = '$email' AND password = '$pswd' AND code = '$code'";
...
<html lang="en">
  <head>
    <title>ShopMax &mdash; Admin-Login</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span><strong class="text-black">Admin Login</strong></div>
        </div>
      </div>
    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" value="shubham14243@email.com" id="c_email_address" name="email">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      ...
                      <input type="password" class="form-control" value="shubham123" id="c_password" name="password">
                    </div>
                  </div>

                  <div class="form-group row">
                    <div class="col-md-12">
                      <label for="c_code" class="text-black">Code <span class="text-danger">*</span></label>
                      <input type="password" class="form-control" value="123123" id="c_code" name="code">
                    </div>
                  </div>
